    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Words",
                columns: new[] { "Id", "Category", "CreatedAt", "Definition", "DifficultyLevel", "Example", "Term" },
                values: new object[,]
                {
                    { 1, "Food", new DateTime(2026, 5, 20, 23, 43, 53, 480, DateTimeKind.Local).AddTicks(7713), "Quả táo", 0, "I eat an apple every day.", "Apple" },
                    { 2, "Animals", new DateTime(2026, 5, 20, 23, 43, 53, 480, DateTimeKind.Local).AddTicks(7726), "Con chó", 0, "The dog is very friendly.", "Dog" }
                });
